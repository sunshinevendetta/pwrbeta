...
export default function DisconnectedPage() {
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center bg-black text-white text-center p-6">
      <h1 className="text-4xl font-bold">This site is offline due to non-payment and lack of responsibility from the CEO at DFB (Decentralized Future Builders).</h1>
