...
export default function Blogs() {
  // Filter blog data to include only entries with "Trading" or "Trading Tournament" tags
    ...
    <>
      <div className="container relative md:mt-24 mt-16">
        <div className="grid grid-cols-1 pb-6 text-center">
          <h3 className="mb-4 md:text-2xl md:leading-normal text-2xl leading-normal font-semibold">Trading News</h3>
          <p className="text-slate-400 max-w-xl mx-auto">Focused insights on Trading and Trading Tournaments to empower your innovations.</p>
        </div>
