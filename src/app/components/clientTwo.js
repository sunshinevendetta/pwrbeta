        ...
        <>
         <div className="container relative md:mt-24 mt-16">
                <div className="grid grid-cols-1 pb-6 text-center">
                    <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">Speakers Line Up</h3>

                    <p className="text-slate-400 max-w-xl mx-auto">Pioneers and rebels of decentralized tech, art, AI, and robotics. They are here to ignite minds of rookies and veterans.</p>
                </div>
            </div>
                                ...
                                <ul className="space-y-4">
                                    <li className="rounded-lg shadow dark:shadow-gray-800 p-6 border-b-4 border-amber-400">
                                        <div className="flex items-center pb-6 border-b border-gray-200 dark:border-gray-800">
                                            <Image src="/images/client/tba.png" width={64} height={64} className="h-16 w-16 rounded-full shadow dark:shadow-gray-800" alt=""/>
            
                                            <div className="ps-4">
                                                <Link href="" className="text-lg hover:text-amber-400 duration-500 ease-in-out">To Be Announced</Link>
                                                <p className="text-slate-400">Coming Soon</p>
                                            </div>
                                        </div>
            
                                        <div className="mt-6">
                                            <p className="text-slate-400">April 2024</p>
