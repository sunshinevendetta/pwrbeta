...
export default function Blogs() {
  // Filter blog data to include only entries with "Web3" or "Hackathon" tags
    ...
    <>
      <div className="container relative md:mt-24 mt-16">
        <div className="grid grid-cols-1 pb-6 text-center">
          <h3 className="mb-4 md:text-2xl md:leading-normal text-2xl leading-normal font-semibold">Web3 News</h3>
          <p className="text-slate-400 max-w-xl mx-auto">Focused insights on Web3 and Hackathons to empower your innovations.</p>
        </div>
