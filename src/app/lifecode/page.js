    ...
    const casesData = [
        {
            ...
            title: 'Sign-Up',
            desc: 'A unique hacker pass, mintable for free, serves as the entry ticket, if you are a student you do not need to pay for mint fees, just upload your institution ID or put the name of your institution to get the discount.'
        },
        {
            icon: GiTeamIdea,
        ...
        <section className="relative md:py-24 py-16">
          <div className="container relative md:mt-24 mt-16">
            <div className="grid grid-cols-1 pb-6 text-center">
              ...
              <p className="text-white font-semibold max-w-xl mx-auto">Explore genetics, wearable technology, and new health paradigms to enhance human capabilities and longevity.</p>
            </div>
