...
const WTCScene = () => {
  ...
  useEffect(() => {
    ...
    const loadScene = async () => {
      ...
      const camera = new THREE.PerspectiveCamera(120, containerRef.current.clientWidth / containerRef.current.clientHeight, 0.1, 1000);
      camera.position.set(0, 0, 120); // Adjust camera position as needed
      ...
      loader.load('https://raw.githubusercontent.com/sunshinevendetta/Vibesocialclub/main/images/wtc.glb', function (gltf) {
