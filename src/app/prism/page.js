...
export default function Services() {
    ...
    const casesData = [
      ...
      {
          icon: RiLightbulbFlashFill,
          image: '/images/blog/guidelines.jpg',
      ...
      {
          icon: RiLightbulbFlashFill,
          image: '/images/blog/copyright.jpg',
      ...
      {
          icon: RiLightbulbFlashFill,
          image: '/images/blog/integrations.jpg',
          title: 'Integrations',
    ...
    return (<>
        ...
        <section className="relative md:py-24 py-16">
          <div className="container relative md:mt-24 mt-16">
            ...
            <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">Prism Art Contest</h3> <p className="text-slate-400 max-w-xl mx-auto">Explore the captivating fusion of math and art in our prism contest. Create stunning algorithmic artworks embodying acceleration. Top prize: $10,000.</p>
            </div>
